...
//        var path = ms.http.baseUrl + "/Accessory/" + id + ".img/";
//        var instance = this; ms.http.getJsonPropertyForPath(path, (data) => {
//            instance.dx = data.x;
//            instance.dy = data.y;
//        });
...
//        var path = ms.http.baseUrl + "/Coat/" + id + ".img/";
...
//        var path = ms.http.baseUrl + "/Face/" + id + ".img/";
...
//        this.id = id;
//        var path = ms.http.baseUrl + "/Glove/" + id + ".img/";
//        var instance = this; ms.http.getJsonPropertyForPath(path, (data) => { });
...
//        var path = ms.http.baseUrl + "/Hair/" + id + ".img/";
//        var instance = this; ms.http.getJsonPropertyForPath(path, (data) => { });

//        if (File.Exists(ms.http.baseUrl + "/Hair/" + id + ".img/default.hairBelowBody.png")) {
//            back = new Texture(ms.http.baseUrl + "/Hair/" + id + ".img/default.hairBelowBody.png");
...
//        var path = ms.http.baseUrl + "/Cap/" + id + ".img/";
//        try {
...
//        var path = ms.http.baseUrl + "/Skin/" + id + ".img/";
...
//        var path = ms.http.baseUrl + "/Shoes/" + id + ".img/";
//        var instance = this; ms.http.getJsonPropertyForPath(path, (data) => { });
...
//        var path = ms.http.baseUrl + "/Pants/" + id + ".img/";
